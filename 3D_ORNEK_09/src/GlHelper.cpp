...
GlHelper::GlHelper() {
	...
	std::copy(vertexPosition, vertexPosition + 4*6, this->vertexPosition);
	std::copy(vertexColors, vertexColors + 4*6, this->vertexColors);
	...
	glFrontFace(GL_CW);/*counterclockwise https://www.opengl.org/sdk/docs/man/html/glFrontFace.xhtml*/
